...
<body>
    <div class="container">
        ...
        <div>
            ...
            <span class="badge badge-stars">★ 0</span>
            <span class="badge badge-forks">Forks: 0</span>
        </div>
...
// Your PHP code here...
        ...
        <p>*Include screenshots or GIFs demonstrating the editor interface, file navigation, editing, and other features.*</p>
        <!-- Example Screenshot -->
        ...
        <p class="credits">
            ...
            <a href="https://www.instagram.com/abdoualittlebit" target="_blank">Abdou Traya (@abdoualittlebit)</a> and 
            <a href="https://www.instagram.com/putout" target="_blank">Abdou Traya (@putout)</a>.
            <br>
